...
rem Last revised by Grigory Filatov 21/11/2012
rem
rem Syntax:
rem
...
%MG_ROOT%\harbour\bin\hbmk2.exe -compiler=bcc -D_HBMK_ %GT% %WARN% -q %RUN% %INCREMENTAL% -head=%HEAD% %REBUILD% %DEBUG% -mt -i%~dp0..\..\sslib\include -l%~dp0..\..\sslib\lib\sslib.lib -l%~dp0..\..\sslib\lib\sserror.lib -l%~dp0..\..\sslib\lib\taxprg.lib  -l%~dp0..\..\minigui\harbour\lib\hbnf.lib -l..\..\minigui\harbour\lib\hbcomm.lib -l..\..\minigui\harbour\lib\hbnetio.lib -l%~dp0..\..\minigui\harbour\lib\zlib.lib -l%~dp0..\..\borland\bcc55\lib\ws2_32.lib -l%~dp0..\..\minigui\harbour\lib\calldll.lib -l%~dp0..\..\minigui\harbour\lib\hbct.lib -l%~dp0..\..\minigui\lib\socket.lib %1 %2 %3 %4 %5 %6 %7 %8 %9 -L${HB_DYN} minigui.hbc > error.log
...
if exist error.log %MG_ROOT%\batch\showerr error.log
